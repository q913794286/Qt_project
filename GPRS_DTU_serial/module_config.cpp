...
////    ui->comboBox_stopw->addItem(QStringLiteral("1.5"));
    ...
    radioGroup1->addButton(ui->radioButton_pass,1);
    radioGroup1->addButton(ui->radioButton_aes128 ,2);
    ...
    ui->lineEdit_IV->setText(QString(IV));
    ui->lineEdit_ID->setText(QString(ID));
